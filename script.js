            ...
            <div class="card-content">
                ...
                <div class="main-content">
                    ...
                    <div class="clue-content">
                        <div class="clue-text">
                            <div class="actor-name">${currentCard.actors[0]}</div>
                            <div class="ampersand">&</div>
                            <div class="actor-name">${currentCard.actors[1]}</div>
                        </div>
                    </div>
                </div>
                <div class="bottom-content">
            ...
            <div class="card-content">
                <div class="title-container">
                    <div>
                        ...
                        <div class="movies">${currentCard.movies[0]}<br>&<br>${currentCard.movies[1]}</div>
                    </div>
                </div>
                <div class="button-container">
