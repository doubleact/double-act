...
export class DoubleActGame {
    ...
    startSinglePlayer() {
        ...
        // Track game start
        analyticsService.trackGameStart('single', 1, Array.from(this.selectedTypes));
    ...
    startMultiplayerGame() {
        ...
        // Track game start
        analyticsService.trackGameStart('multiplayer', this.numberOfPlayers, Array.from(this.selectedTypes));
    ...
    correctAnswer() {
        ...
        // Track answer
        analyticsService.trackAnswer(this.cards[this.currentCardIndex].id, true, 0);
    }
    ...
    passCard() {
        ...
        // Track answer
        analyticsService.trackAnswer(this.cards[this.currentCardIndex].id, false, 0);
    }
    ...
    showSinglePlayerScore() {
        ...
        // Track game complete
        analyticsService.trackGameComplete(this.score, 0, 'single');
    }
    ...
    showMultiPlayerScore() {
        ...
        // Track game complete
        analyticsService.trackGameComplete(this.playerScores[0].correct, 0, 'multiplayer');
    }
